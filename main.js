    ...
    function checkWinner(){        
        ...
        for(let i = 0; i<=inputs.length; i++){
            if(!option1[i] || !option2[i]) {
                return document.getElementById("result").textContent="Please enter rock, paper or sccisors"
            }
        }
        ...
        if(option1 === option2) {
            ...
            document.getElementById("result").textContent=`${option2.toUpperCase()} wins` 
        }else if(option1 === "rock" && option2 === "sccisors" ){
            document.getElementById("result").textContentL=`${option1.toUpperCase()} wins`
        }else if(option1 === "sccisors" && option2 === "rock"){
            document.getElementById("result").textContent=`${option2.toUpperCase()} wins`
        }else if(option1 === "sccisors" && option2 === "paper"){
            document.getElementById("result").textContent=`${option1.toUpperCase()} wins`
